...
?>	
	<div class='fichero' data-src="<?php echo $BASE_URL; ?>Admin/images/<?php echo $filename; ?>">
		<img src="<?php echo $BASE_URL; ?>Admin/images/<?php echo $filename; ?>" />
