    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="main-header">
                <div class="header" style="background-color: #F9A62B ;">
                    <h3>ជីវិតនិងសង្គម <i class="fa-solid fa-chevron-right"></i></h3>
                </div>
            </div>
            <div class="main-box-category" style="border-top: 3px solid #F9A62B;">
            <div class="btn-next" style="color:#F9A62B"><i class="fa-solid fa-chevron-right"></i></div>
                <div class="left-box">
                    <div class="img-box">
                        <div class="cover-img">
                    ...
                    <div class="txt-box" style="background-color: #F9A62B;">
