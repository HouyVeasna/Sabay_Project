    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="main-header">
                <div class="header" style="background-color: #555555 ;">
                    <h3>DEALS <i class="fa-solid fa-chevron-right"></i></h3>
                </div>
            </div>
            <div class="main-box-category" style="border-top: 3px solid #555555;">
            <div class="btn-next" style="color:#FA1939"><i class="fa-solid fa-chevron-right"></i></div>
                <div class="left-box">
                    <div class="img-box">
                        <div class="cover-img">
                    ...
                    <div class="txt-box" style="background-color: #FA1939;">
